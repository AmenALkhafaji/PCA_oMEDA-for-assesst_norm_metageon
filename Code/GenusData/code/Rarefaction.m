...
% ## Ploting Omeda for high depth and comparing to ground truth
...
loadingsPca(microbiome_data,"PCs",[1 2],'VarsLabel',myemptylabell','VarsClass',lab');
