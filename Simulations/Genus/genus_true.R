...
prob_unhealthy <- c(
  0.38, 0.6, 1.5, 0, 26, 0.01, 0.02, 11, 0.7, 1, 0.14, 1,
  0.15, 0.3, 0, 0.3, 3.00, 0.14, 0.02, 0.5, 1, 0.14, 2, 4.8,
  0, 0.2, 0.05, 5, 3, 2.7, 0.8, 8, 0.22, 0, 0.31, 1.23
)
...
simulate_group <- function(n, probs, group_label) {
  ...
  df$group <- factor(group_label)   # 1=Healthy, 2=Unhealthy
  df
}
